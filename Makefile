...
.PHONY: docker-build-store-operations-mcp docker-build-customer-concierge-agent
...
docker-build-agent-mcp-images: docker-build-catalog-mcp docker-build-customer-mcp docker-build-store-operations-mcp docker-build-customer-concierge-agent docker-build-store-manager-agent docker-build-catalog-specialist-agent docker-build-reservation-specialist-agent docker-build-message-drafter-agent
